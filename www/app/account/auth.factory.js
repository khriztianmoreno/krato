(function () {
    ...
    Auth.$inject = ['FURL', '$firebaseAuth', '$firebaseArray', '$firebaseObject', 'Utils', '$localStorage'];

    function Auth(FURL, $firebaseAuth, $firebaseArray, $firebaseObject, Utils, $localStorage) {
